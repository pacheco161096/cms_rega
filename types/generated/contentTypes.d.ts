...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    regimen_fiscal: Attribute.String;
    cfdi: Attribute.String;
    colonia: Attribute.String;
    codigo_postal: Attribute.String;
    calle: Attribute.String;
    num_exterior: Attribute.String;
    num_interior: Attribute.String;
...
export interface ApiCardCard extends Schema.CollectionType {
  ...
  attributes: {
    ...
    activeButton: Attribute.Boolean &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDocumentoDocumento extends Schema.CollectionType {
...
export interface ApiPaquetePaquete extends Schema.CollectionType {
  ...
  attributes: {
    ...
    velocidad: Attribute.Integer &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    tipo: Attribute.Enumeration<['hogar', 'negocio']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    recargo: Attribute.Float &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    folio: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    categoria: Attribute.Enumeration<['asimetrico', 'simetrico']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTraslateCopyTraslateCopy extends Schema.CollectionType {
  ...
  info: {
    singularName: 'traslate-copy';
    pluralName: 'traslate-copies';
    displayName: 'traslateCopy';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::traslate-copy.traslate-copy',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
